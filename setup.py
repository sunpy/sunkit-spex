...
PACKAGENAME = metadata.get('package_name', 'sunxspex')
DESCRIPTION = metadata.get('description', 'A package for solar X-ray spectroscopy')
AUTHOR = metadata.get('author', 'Dan Ryan')
...
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: sunxspex requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
