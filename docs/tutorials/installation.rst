...
To install the latest stable release of ``sunkit-spex`` from PyPI using pip:
...
To additionally install the legacy optional dependency, needed for the legacy fitting code and examples, use:
