...
def test_scipy_minimize():
    ...
    opt_res0 = MINIMIZERS["scipy_minimize"](minimize_func, model_param_values0, (sim_data0, sim_x0, sim_model0, statistics.chi_squared))
    ...
    opt_res1 = MINIMIZERS["scipy_minimize"](minimize_func, model_param_values1, (sim_data1, sim_x1, sim_model1, statistics.chi_squared))
