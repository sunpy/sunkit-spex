...
from sunkit_spex.fitting.data_loader import LoadSpec
from sunkit_spex.fitting.instruments import rebin_any_array
from sunkit_spex.fitting.likelihoods import LogLikelihoods
from sunkit_spex.fitting.parameter_handler import Parameters, isnumber
from sunkit_spex.fitting.photon_models_for_fitting import (  # noqa
    defined_photon_models,
    f_vth,
    thick_fn,
    thick_warm,
)
from sunkit_spex.fitting.rainbow_text import rainbow_text_lines
    ...
    **kwargs : Passed to LoadSpec.
    ...
    def del_photon_model(self, function_name):
        ...
        if inspect.getmodule([function_name]).__name__ in (__name__):
            ...
            logger.warning(
                "Default models imported from sunkit_spex.fitting.photon_models_for_fitting are protected.")
