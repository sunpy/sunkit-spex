...
from sunkit_spex.fitter_legacy import instruments as inst  # sunkit_spex.fitter_legacy.instruments
from sunkit_spex.fitter_legacy.parameter_handler import (  # sunkit_spex.fitter_legacy.parameter_handler
    _make_into_list,
    isnumber,
)
...
class LoadSpec:
    ...
    **kwargs :
    ...
    def __init__(self, *args, pha_file=None, arf_file=None, rmf_file=None, srm_file=None, srm_custom=None, custom_channel_bins=None, **kwargs):
        ...
        # from sunkit_spex.fitter_legacy.instruments import * gives us the instrument specific loaders, keys should match up to the "TELESCOP" header entry in spec file
